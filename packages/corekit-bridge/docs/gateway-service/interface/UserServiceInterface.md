...
**Type:** `(params: unknown) => Promise<GatewayResult<User>>`
...
**Type:** `(params: LoginParams) => Promise<GatewayResult<Credential>>`
...
**Type:** `(params: unknown, config: GatewayConfig) => Promise<GatewayResult<User>>`
