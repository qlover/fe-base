...
**Type:** `MessageSenderPlugin<MessageType>[]`
...
**Type:** `(task: MessageSenderTask<R, MessageType>) => Promise<R>`
...
**Type:** `(context: MessageSenderContext<MessageType>) => void`

#### Parameters

| Name      | Type                                | Optional | Default | Since | Deprecated | Description                                |
| --------- | ----------------------------------- | -------- | ------- | ----- | ---------- | ------------------------------------------ |
| `context` | `MessageSenderContext<MessageType>` | ❌       | -       | -     | -          | Execution context containing hook runtimes |
...
| Name      | Type                                | Optional | Default | Since | Deprecated | Description                                      |
| --------- | ----------------------------------- | -------- | ------- | ----- | ---------- | ------------------------------------------------ |
| `context` | `MessageSenderContext<MessageType>` | ❌       | -       | -     | -          | Execution context with message sender parameters |
...
**Type:** `(chunk: unknown, context: MessageSenderContext<MessageType>) => Promise<unknown>`
