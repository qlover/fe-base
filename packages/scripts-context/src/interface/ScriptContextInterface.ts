...
import type { ScriptSharedInterface } from './ScriptSharedInterface';
import type { FeConfig } from '../feConfig';
import type { ExecPromiseFunction } from '../implement/Shell';
 ...
 * ```
 */
export interface ScriptContextInterface<Opt extends ScriptSharedInterface> {
  /**
