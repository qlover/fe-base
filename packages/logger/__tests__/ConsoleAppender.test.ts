...
describe('ConsoleAppender', () => {
  ...
  it('should use formatter when provided', () => {
    ...
    expect(console.warn).toHaveBeenCalledWith(`[${formattedTimestamp} warn]`, 'Warning message');
  });
  ...
  it('should set formatter via setFormatter method', () => {
    ...
    expect(console.info).toHaveBeenCalledWith(`[${formattedTimestamp} info]`, 'Test message');
  });
