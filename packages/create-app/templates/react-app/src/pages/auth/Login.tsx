...
export default function Login() {
  ...
  return (
    <div className="flex min-h-screen text-xs1 bg-[rgb(var(--color-bg-base))]">
      {/* Left side - Brand section */}
      <div className="hidden lg:flex lg:w-1/2 bg-[rgb(var(--color-bg-secondary))] p-12 flex-col">
        <div className="flex items-center gap-3 mb-12">
          <div className="w-10 h-10 bg-[rgb(var(--color-brand))] rounded-lg"></div>
      ...
      <div className="w-full lg:w-1/2 p-8 sm:p-12 flex items-center justify-center">
        <div className="w-full max-w-[420px]">
          <h2 className="text-2xl font-semibold mb-2 text-[rgb(var(--color-text-primary))]">
          ...
          >
            ...
            >
              <Input
                prefix={<UserOutlined className="text-[rgb(var(--color-text-tertiary))]" />}
                placeholder={t('email')}
                className="h-12 text-base bg-[var(--login-input-bg)] border-[var(--login-input-border)]"
              />
            </Form.Item>
...
function FeatureItem({ icon, text }: { icon: string; text: string }) {
  return (
    <div className="flex items-center gap-3 text-[rgb(var(--color-text-primary))]">
      <div className="w-8 h-8 bg-[rgb(var(--color-bg-elevated))] rounded-lg flex items-center justify-center">
        {icon}
      </div>
      <span>{text}</span>
    </div>
