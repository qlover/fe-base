 ...
 */
export const PAGE_EXECUTOR_TITLE = 'page_executor:title';
 ...
 */
export const PAGE_EXECUTOR_DESCRIPTION = 'page_executor:description';

/**
 * @description Executor page keywords
 * @localZh 任务执行器, 任务类型, 任务状态
 * @localEn Task Executor, Task Type, Task Status
 */
export const PAGE_EXECUTOR_KEYWORDS = 'page_executor:keywords';
 ...
 * @localEn Executor
 */
export const PAGE_EXECUTOR_MAIN_TITLE = 'page_executor:main_title';
...
export const PAGE_EXECUTOR_TEST_PLUGIN_TITLE =
  'page_executor:test_plugin.title';
...
export const PAGE_EXECUTOR_TASK_STATUS_PENDING =
  'page_executor:task.status.pending';
...
export const PAGE_EXECUTOR_TASK_STATUS_RUNNING =
  'page_executor:task.status.running';
...
export const PAGE_EXECUTOR_TASK_STATUS_COMPLETED =
  'page_executor:task.status.completed';
...
export const PAGE_EXECUTOR_TASK_STATUS_FAILED =
  'page_executor:task.status.failed';
...
export const PAGE_EXECUTOR_TASK_TYPE_DATA_SYNC =
  'page_executor:task.type.data_sync';
 ...
 */
export const PAGE_EXECUTOR_TASK_TYPE_REPORT = 'page_executor:task.type.report';
...
export const PAGE_EXECUTOR_TASK_TYPE_MAINTENANCE =
  'page_executor:task.type.maintenance';
 ...
 * @localEn Backup
 */
export const PAGE_EXECUTOR_TASK_TYPE_BACKUP = 'page_executor:task.type.backup';
...
export const PAGE_EXECUTOR_TASK_DURATION_UNIT =
  'page_executor:task.duration.unit';
 ...
 * @localEn Start
 */
export const PAGE_EXECUTOR_TASK_START = 'page_executor:task.start';
 ...
 * @localEn Stop
 */
export const PAGE_EXECUTOR_TASK_STOP = 'page_executor:task.stop';
 ...
 */
export const PAGE_EXECUTOR_TASK_SUCCESS = 'page_executor:task.success';
 ...
 */
export const PAGE_EXECUTOR_TASK_FAILURE = 'page_executor:task.failure';
...
export const PAGE_EXECUTOR_PLUGIN_TEST_SUCCESS =
  'page_executor:plugin.test.success';
...
export const PAGE_EXECUTOR_PLUGIN_TEST_FAILURE =
  'page_executor:plugin.test.failure';
...
export const PAGE_EXECUTOR_CUSTOM_TASK_URL_REQUIRED =
  'page_executor:custom_task.url_required';
 ...
 */
export const PAGE_EXECUTOR_CUSTOM_TASK_NAME = 'page_executor:custom_task.name';
...
export const PAGE_EXECUTOR_CREATE_TASK_TITLE =
  'page_executor:create_task.title';
 ...
 * @localEn Create
 */
export const PAGE_EXECUTOR_CREATE_BUTTON = 'page_executor:create_button';
 ...
 * @localEn Enter URL
 */
export const PAGE_EXECUTOR_ENTER_URL = 'page_executor:enter_url';
 ...
 * @localEn Task List
 */
export const PAGE_EXECUTOR_TASK_LIST_TITLE = 'page_executor:task_list.title';
 ...
 * @localEn Total Tasks
 */
export const PAGE_EXECUTOR_TASK_STATS_TOTAL = 'page_executor:task_stats.total';
...
export const PAGE_EXECUTOR_TASK_STATS_RUNNING =
  'page_executor:task_stats.running';
...
export const PAGE_EXECUTOR_TASK_STATS_COMPLETED =
  'page_executor:task_stats.completed';
...
export const PAGE_EXECUTOR_TASK_STATS_FAILED =
  'page_executor:task_stats.failed';
...
export const PAGE_EXECUTOR_TASK_HISTORY_TITLE =
  'page_executor:task_history.title';
 ...
 * @localEn Need Help?
 */
export const PAGE_EXECUTOR_HELP_TITLE = 'page_executor:help.title';
 ...
 */
export const PAGE_EXECUTOR_HELP_DESCRIPTION = 'page_executor:help.description';
 ...
 * @localEn View Guide
 */
export const PAGE_EXECUTOR_VIEW_GUIDE = 'page_executor:view_guide';
 ...
 */
export const PAGE_EXECUTOR_CONTACT_SUPPORT = 'page_executor:contact_support';
 ...
 */
export const PAGE_EXECUTOR_REQUEST_TIMEOUT = 'page_executor:request.timeout';
