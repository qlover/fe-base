...
export class UserRepository implements UserRepositoryInterface {
  ...
  async pagination<UserSchema>(params: PaginationParams): Promise<PaginationResult> {
...
export class MongoDBBridge implements DBBridgeInterface {
  ...
  protected buildQuery(where: Where[]): Document {
    return where.reduce((query, [field, operation, value]) => {
      switch (operation) {
        case '=': return { ...query, [field]: value };
        case '!=': return { ...query, [field]: { $ne: value } };
        case '>': return { ...query, [field]: { $gt: value } };
        case '<': return { ...query, [field]: { $lt: value } };
        case '>=': return { ...query, [field]: { $gte: value } };
        case '<=': return { ...query, [field]: { $lte: value } };
...
export class UserService {
  ...
  async listUsers(params: PaginationParams): Promise<PaginationResult<UserProfile>> {
