 ...
 */
export const PAGE_JSONSTORAGE_TITLE = 'page__jsonstorage__title';
 ...
 */
export const PAGE_JSONSTORAGE_DESCRIPTION = 'page__jsonstorage__description';
 ...
 */
export const PAGE_JSONSTORAGE_MAIN_TITLE = 'page__jsonstorage__main_title';
/**
...
export const PAGE_JSONSTORAGE_PERMANENT_TITLE =
  'page__jsonstorage__permanent_title';
 ...
 */
export const PAGE_JSONSTORAGE_EXPIRE_TITLE = 'page__jsonstorage__expire_title';
/**
 ...
 */
export const PAGE_JSONSTORAGE_FORMAT_TITLE = 'page__jsonstorage__format_title';
/**
 * @description JSONStorage set random value button
 * @localZh 设置随机值
 * @localEn Set Random Value
 */
export const PAGE_JSONSTORAGE_SET_RANDOM = 'page__jsonstorage__set_random';
/**
 ...
 */
export const PAGE_JSONSTORAGE_SET_EXPIRE = 'page__jsonstorage__set_expire';
/**
 * @description JSONStorage milliseconds unit
 * @localZh 毫秒
 * @localEn ms
 */
export const PAGE_JSONSTORAGE_MS = 'page__jsonstorage__ms';
