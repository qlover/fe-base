/**
 * @module @qlover-eslint
 * @description ESLint plugin providing TypeScript and React-specific linting rules for code quality and consistency
 *
 ...
 *
 * @see [ESLint Plugin Documentation](https://eslint.org/docs/latest/extend/plugins)
 */
...
import {
  ...
  RULE_NAME as TS_CLASS_OVERRIDE
} from './rules/ts-class-override';
...
const configs: {
  ...
  recommended: {
    ...
    rules: {
      ...
      [`@qlover-eslint/${TS_CLASS_OVERRIDE}`]: 'error'
    }
  }
};
...
const rules = {
  ...
  [TS_CLASS_OVERRIDE]: tsRequireOverrideComment
} as const;
