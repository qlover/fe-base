...
HTTP request management system with adapter pattern and plugin support
...
```typescript
import { RequestExecutor, RequestAdapterFetch } from '@qlover/fe-corekit';
...
```typescript
import { RequestExecutor, RequestHeaderInjector } from '@qlover/fe-corekit';
