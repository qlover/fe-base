## `src/executor/interface/SyncLifecyclePluginInterface` (Module)

**Type:** `module src/executor/interface/SyncLifecyclePluginInterface`

---

### `LifecycleSyncPluginInterface` (Interface)

**Type:** `interface LifecycleSyncPluginInterface<Ctx, Result, Param>`
...
```typescript
const validationPlugin: LifecycleSyncPluginInterface<
...
```typescript
const transformPlugin: LifecycleSyncPluginInterface<
  ExecutorContextInterface<any>
> = {
