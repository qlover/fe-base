## `src/executor/impl/LifecycleSyncExecutor` (Module)

**Type:** `module src/executor/impl/LifecycleSyncExecutor`

---

### `LifecycleSyncExecutor` (Class)

**Type:** `class LifecycleSyncExecutor<Ctx, Plugin>`
...
#### `new LifecycleSyncExecutor` (Constructor)

**Type:** `(config: PluginExecutorConfig) => LifecycleSyncExecutor<Ctx, Plugin>`
...
**Type:** `(plugins: Plugin[], hookName: string, context: ExecutorContextImpl<Params, unknown, HookRuntimes>, args: unknown[]) => undefined \| Result`
...
**Type:** `(plugins: Plugin[], hookNames: string \| string[], context: ExecutorContextImpl<Params, unknown, HookRuntimes>, args: unknown[]) => undefined \| Result`
