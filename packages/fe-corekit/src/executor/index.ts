/**
 * @module Executor
 * @description Lifecycle-based task execution framework with plugin support
 *
 ...
 * const processed = await executor.exec(
 *   { input: 'hello' },
 *   async (ctx) => {
 ...
 *
 * // With parameters
 * const doubled = executor.exec(
 *   { value: 21 },
 *   (ctx) => ctx.parameters.value * 2
 * );
 * ```
 *
 * @see {@link LifecycleExecutor} for async execution
 * @see {@link LifecycleSyncExecutor} for sync execution
 * @see {@link LifecyclePluginInterface} for plugin development
 */
export * from './impl';
export * from './interface';
export * from './plugins';
export * from './utils/constants';
export * from './utils/pluginHook';
export * from './utils/pluginHookSync';
