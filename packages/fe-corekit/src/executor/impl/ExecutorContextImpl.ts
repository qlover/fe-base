...
import { ExecutorError, HookRuntimes } from '../interface';
 ...
 */
export class ExecutorContextImpl<T = unknown>
  implements ExecutorContextInterface<T>
{
  private _parameters: T;
  private _error: ExecutorError | undefined = undefined;
  private _returnValue: unknown = undefined;
  protected _hooksRuntimes: HookRuntimes;
  ...
  /**
   * Get the hooks runtime information
   * This is used internally for plugin execution tracking
   */
  public get hooksRuntimes(): HookRuntimes {
    return this._hooksRuntimes;
  }
