/**
 * @module Encrypt
 * @description Data encryption and decryption interface definitions
 *
 ...
 * ```
 *
 * @see {@link EncryptorInterface} for the encryption interface
 * @see {@link https://github.com/qlover/fe-base/tree/main/packages/corekit-node} for Node.js encryption implementations
 */
