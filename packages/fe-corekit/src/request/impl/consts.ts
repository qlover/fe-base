/**
 * Default authentication header key name
 */
export const DEFAULT_AUTH_KEY = 'Authorization';

/**
 * Content-Type header key name
 */
...
export const RESPONSE_NOT_OK_ID = 'RESPONSE_NOT_OK';
