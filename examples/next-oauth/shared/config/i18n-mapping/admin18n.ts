...
export const adminOtpMonitor18n = Object.freeze({
  ...
  clearAll: otpMonitorKeys.ADMIN_OTP_MONITOR_CLEAR_ALL,
  count: otpMonitorKeys.ADMIN_OTP_MONITOR_COUNT,
  colIp: otpMonitorKeys.ADMIN_OTP_MONITOR_COL_IP,
  colBlockedUntil: otpMonitorKeys.ADMIN_OTP_MONITOR_COL_BLOCKED_UNTIL,
  colTtl: otpMonitorKeys.ADMIN_OTP_MONITOR_COL_TTL,
  colKey: otpMonitorKeys.ADMIN_OTP_MONITOR_COL_KEY,
  colActions: otpMonitorKeys.ADMIN_OTP_MONITOR_COL_ACTIONS,
  delete: otpMonitorKeys.ADMIN_OTP_MONITOR_DELETE,
  ...
  deleteFailed: otpMonitorKeys.ADMIN_OTP_MONITOR_DELETE_FAILED,
  confirmDelete: otpMonitorKeys.ADMIN_OTP_MONITOR_CONFIRM_DELETE,
  confirmClear: otpMonitorKeys.ADMIN_OTP_MONITOR_CONFIRM_CLEAR,
